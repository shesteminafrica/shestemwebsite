      ...
      <div className="max-w-[100rem] mx-auto px-4 md:px-8">
        <div className="flex justify-center items-center mb-12">
          <RevealWrapper delay={0.1} direction="up" className="">
            <h2 className="text-3xl md:text-5xl lg:text-[56px] font-medium">{t("news.title")}</h2>
          </RevealWrapper>
                ...
                <div key={`fgd${index}gfdg`} className="rounded-lg overflow-hidden hover:shadow-md transition-shadow grid grid-cols-2 gap-8 w-full px-5 py-3 cursor-pointer">
                  <div className="flex flex-col justify-between">
                    <div className="flex flex-col gap-3">
                      <div className="text-sm text-[#464A54] border border-[#E7E7E7] rounded-full py-2 px-4 max-w-fit">{item.category}</div>
                    ...
                    <p className="text-[#7E8188] text-sm">
