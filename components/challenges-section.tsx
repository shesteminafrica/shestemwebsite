...
export function ChallengesSection() {
  ...
  const  challenges = [
    {
      ...
      percentage: "35%",
      description: [t("challenges.imbalance.description.0"),t("challenges.imbalance.description.2")],
    },
    {
  ...
  return (
    <section className="w-full max-w-[100rem] mx-auto py-16">
      <div className="mx-auto px-4 md:px-8">
        <RevealWrapper delay={0.1} direction="up" className="mb-12">
          <h2 className="text-3xl md:text-5xl lg:text-[56px] font-medium text-center">{t("challenges.title")}</h2>
        </RevealWrapper>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 ">
            {challenges.map((challenge, index) => (
              <RevealWrapper key={`${index}oc`} delay={0.2 + index * 0.1} direction="up" className="size-full">
                <div className="rounded-xl p-8 flex flex-col gap-4 justify-center size-full">
                  <div className="flex items-center gap-4">
                    ...
                    />
                    <span className="text-gray-900 uppercase text-xl font-medium min-w-max">{challenge.title}</span>
                    <Image
                      src="/trait2.svg"
                      alt="African woman in science lab"
                      width={35}
                  ...
                  <ul>
                    {challenge.description.map((item, index) => (
                      <p key={`${index}d`} className="text-sm text-gray-600 w-72">
                        {item}
                      </p>
                    ))}
                  </ul>
          ...
          <div className="flex items-center justify-center relative">
            <RevealWrapper delay={0.6} direction="left" className="size-full">
        ...
        <RevealWrapper delay={0.7} direction="up" className="mt-16">
          <div className="bg-[url('../public/oc1.png')] bg-cover bg-no-repeat text-white p-8 md:p-12 rounded-4xl text-center relative overflow-hidden flex flex-col items-center w-full">
            ...
            <Button2 value={"challenges.visitOurBlog"} />
          </div>
        </RevealWrapper>
      </div>
    </section>
