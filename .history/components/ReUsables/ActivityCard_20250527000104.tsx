...
const ActivityCard = ({ data, keyId }: { data: ActivityProps, keyId: number }) => {
  ...
  const isEven = keyId % 2 === 0;

  return (
    <div className={styles.activitycard} style={{ flexDirection: isEven ? "row-reverse" : "row" }}>
