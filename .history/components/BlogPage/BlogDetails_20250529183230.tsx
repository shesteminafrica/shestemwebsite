              ...
              <div className={styles.bdb__right}>
                ...
                <div className={styles.social__share}>
                  ...
                  <div className={styles.sc__content}>
                    <div className={styles.sc__icons}>
                      <Icon icon="ri:facebook-fill" className={styles.facebook}/>
                    </div>
                    <div className={styles.sc__icons}>
                      <Icon icon="flowbite:whatsapp-solid" className={styles.whatsapp}/>
                    </div>
                    <div className={styles.sc__icons}>
                      <Icon icon="line-md:instagram" className={styles.instagram}/>
                    </div>
                    <div className={styles.sc__icons}>
                      <Icon icon="line-md:twitter-x" className={styles.twitter}/>
                    </div>
                  </div>
                </div>
