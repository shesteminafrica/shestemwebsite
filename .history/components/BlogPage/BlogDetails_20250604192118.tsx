    ...
    <div className={`sectioner ${styles.bd__section}`}>
      <div className={`containerr ${styles.bd__container}`}>
        ...
        rel="noopener noreferrer" href={shareToFacebook} className={styles.sc__icons}>
                    ...
                    <a target="_blank"
        rel="noopener noreferrer" href={shareToLinkedIn} className={styles.sc__icons}>
                      <Icon
                    ...
                    <a target="_blank"
        rel="noopener noreferrer" href={shareToWhatsApp} className={styles.sc__icons}>
                      <Icon
                    ...
                    <a target="_blank"
        rel="noopener noreferrer" href={shareToTwitter} className={styles.sc__icons}>
                      <Icon
