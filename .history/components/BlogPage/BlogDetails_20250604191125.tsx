...
import React, {useEffectm} from "react";
...
const BlogDetails = () => {
  ...
  const shareToFacebook = `https://www.facebook.com/sharer/sharer.php?u=${encodedUrl}`;
  const shareToTwitter = `https://twitter.com/intent/tweet?text=${encodedTitle}&url=${encodedUrl}`;
              ...
              <div className={styles.bdb__right}>
                ...
                <div className={styles.social__share}>
                  ...
                  <div className={styles.sc__content}>
                    <Link href="/" className={styles.sc__icons}>
                      <Icon
