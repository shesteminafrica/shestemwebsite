  ...
  return (
    <div className={`sectioner ${styles.event__section}`}>
      <div className={`containerr ${styles.event__container}`}>
        ...
        <div className={styles.event__swiper}></div>
      </div>
      <div className={styles.swiper__controls}>
        ...
        <div className={styles.eventswiper__buttons}>
          <div className={styles.angle__left}>
            <Icon icon="fa:angle-left" width="608" height="1280" />
          </div>
          <div className={styles.angle__left}>
            <Icon icon="fa:angle-right" width="608" height="1280" />
          </div>
        </div>
      </div>
    </div>
