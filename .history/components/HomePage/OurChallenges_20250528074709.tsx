            ...
            <div className={styles.occ__block}>
              <div className={styles.ocb__top}>
                <div className={styles.ocb__gradient}>
                  <Image fill quality={100} alt="gradient icon" src={GRADIENT}/>
                </div>
              ...
              • Only 7% of electrical and electronics engineers are women. When it comes to engineering-related professions, the 
              </div>
              </div>
            </div>
          </div>
