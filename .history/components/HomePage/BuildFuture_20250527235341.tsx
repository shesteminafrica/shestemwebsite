        ...
        <div className={styles.bf__content}>
          ...
          <div className={styles.bf__modal}>
            <div className={styles.bfm__left}>
              <h3 className={styles.bfm__h3}>Trouver sa voie dans l'industrie agroalimentaire quand on vient d'une filière STEM l'industrie agroalimentaire quand on vient d'une filière STEM</h3>
