          ...
          <div className={styles.occ__left}>
            ...
            <div className={styles.occ__block}>
              ...
              <div className={styles.ocb__bottom}>
                ...
                <div className={styles.ocb__text}>
                  <p>
                    Only 35% of African students pursue studies in STEM,
                    compared to 50% in other regions of the world.
                  </p>
                  <p>
                    Only 7% of electrical and electronics engineers are women.
                  </p>
                </div>
              </div>
            </div>
