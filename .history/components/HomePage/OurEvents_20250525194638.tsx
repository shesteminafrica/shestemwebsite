    ...
    <div className={`sectioner ${styles.event__section}`}>
      <div className={`containerr ${styles.event__container}`}>
        ...
        <div className={styles.event__swiper}>
          <Swiper slidesPerView={3.5} spaceBetween={20} speed={500} className={styles.eswiper__wrapper} onSlideChange={() => setUserSwipe((prev) => prev + 1)}>
            {
      ...
      <div className={styles.swiper__controls}>
        ...
        <div className={styles.eventswiper__buttons}>
          <div className={styles.eangle} onClick={() => leftButton.current?.click()}>
            <Icon icon="fa:angle-left" />
          </div>
          <div className={styles.eangle} onClick={() => rightButton.current?.click()}>
