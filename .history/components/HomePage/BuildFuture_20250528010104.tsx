    ...
    <div className={`sectioner ${styles.bf__section}`}>
      <div className={`containerr ${styles.bf__container}`}>
        ...
        <div className={styles.bf__content}>
          ...
          <motion.div className={`${styles.bf__modal}`}key={activeSelector}>
            <div className={styles.bfm__left}>
              <h3 className={styles.bfm__h3}>{BuildFutureData[activeSelector].title}</h3>
              <p className={styles.bfm__p}>{BuildFutureData[activeSelector].text}</p>
