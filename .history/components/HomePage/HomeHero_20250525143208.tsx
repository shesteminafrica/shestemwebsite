      ...
      <div className={styles.hero__content}>
        <div className={`containerr ${styles.hc__container}`}>
          ...
          <div className={styles.hero__bottom}>
            {
              heroBottom.map((data, i) => (
                <div className={styles.bottom__div} key={i}>
                  <div className={styles.bd__image} style={{aspectRatio: data.ratio}}>
                    <Image fill quality={100} src={data.image} alt={data.name}/>
                  </div>
                  <p className={styles.p__bottom}>{data.name}</p>
                </div>
              ))
            }
          </div>
