...
const ContactForm = () => {
  ...
  const y = useTransform(scroll1, [0, 1], [-120, 0]);
        ...
        <div className={styles.cf__wrapper}>
          <div className={styles.cf__hero}>
            ...
            <div className={styles.cf__content}>
              ...
              <p className={styles.cf__p}>Please do not hesitate to contact us with your requirements. We will get back to you as soon as possible.</p>
            </div>
          </div>
