...
const MainForm = () => {
  ...
  const firsttwo = ContactFormFields.slice(0, 2); // Gets the first 6 items
  const lastTwo = ContactFormFields.slice(2, 4); // Gets the last 2 items
  const textArea = ContactFormFields[4];
